...
export default class TambahKK extends Component {
  ...
  _GetKecamatan = async () => {
    ...
    let url =
      "https://host02.birosolusi.com/edesa/public/api/v1/wilayah/districts";
  ...
  _GetDesa = async () => {
    ...
    let url =
      "https://host02.birosolusi.com/edesa/public/api/v1/wilayah/subdistricts";
  ...
  _GetKodePos = async () => {
    ...
    let url =
      "https://host02.birosolusi.com/edesa/public/api/v1/wilayah/postalcodes";
  ...
  renderFileFoto() {
    if (this.state.fotokk != "") {
      return (
        ...
        >
          <Image
            source={{ uri: this.state.fotokk }}
            style={{ width: 200, height: 200 }}
          />
          <TouchableOpacity
            onPress={() => {
              this.setState({ fotokk: "" });
            }}
          >
            <Icon
              style={styles.hapusFile}
              name="close-outline"
              size={22}
              color="#a12927"
            />
          </TouchableOpacity>
          <Text style={styles.uploadText}>{this.state.fotokk.fileName}</Text>
        </View>
      );
    } else {
      return (
