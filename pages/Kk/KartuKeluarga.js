    ...
    renderItem = ({ item, index }, onClick) => {
                    ...
                    <TouchableOpacity style={{
                        ...
                        onPress={() => {
                            Alert.alert(
                                ...
                                'Nama : '+item.head.penduduk.legal_name+'\n'+'No. KK : '+item.kk,
                                [
        ...
        return (
            <Swipeable
                ...
                rightOpenValue={-100}>
                <TouchableOpacity onPress={() => this.props.navigation.navigate('Detail Data Kartu Keluarga',{
                    id: item.id,
                })}>
            ...
            <View style={styles.container}>
                ...
                <View>
                    <TouchableOpacity style={styles.footerBtn}
                        activeOpacity={0.5}
                        onPress={() => this.props.navigation.replace('Tambah Kartu Keluarga')}>
