...
export default class DetailKK extends Component {
  ...
  _GetDetail = async () => {
    ...
    let url =
      "http://10.0.0.151:8000/api/v1/kks/c999181c-a8d5-421b-8cd8-b683d5191cc5";
  ...
  editAlamat = async () => {
    ...
    const postalCode = JSON.parse(
      this.state.dataAllKodePos.map((ikp) => ikp.id),
    );
  ...
  simpanFoto = () => {
    ...
    var path_kk = {
      uri:
        "data:" +
        this.state.fotokk.type +
        ";base64," +
        this.state.fotokk.base64,
        ...
        <View>
          ...
          >
            <View style={{ flexDirection: "row" }}>
              <Icon name={"create-outline"} color={"#4E4F6F"} size={20} />
              <Text style={{ fontSize: 13, color: "#4E4F6F", top: 5, left: 1 }}>
                Edit
              </Text>
            </View>
          </TouchableOpacity>
        ...
        <View>
          <Image
            source={{
              uri:
                Platform.OS === "android"
                  ? this.state.fotokk.uri
                  : this.state.fotokk.uri.replace("file://", ""),
            }}
            style={{
              top: 5,
              left: 10,
  ...
  renderNoKK = () => {
    if (this.state.noKK != this.state.data.kk) {
      return (
        <TouchableOpacity style={styles.regBtn} onPress={() => this.editNoKK()}>
                ...
                <View style={styles.viewList}>
                  <View style={styles.textWrap}>
                    <View style={styles.itemWrap}>
                      <Text style={styles.textItem}>Kepala Keluarga</Text>
                          ...
                          <View style={styles.tambahSubContainer}>
                            ...
                            <View style={[styles.itemWrap, { padding: 10 }]}>
                              <Text style={styles.textItem}>
                                Masukkan Anggota Keluarga
                              </Text>
                              <SelectDropdown
                                data={this.state.dataPenduduk.map(
                                  (d) => d.legal_name,
                                )}
                    ...
                    <View style={styles.itemWrap}>
                      <Text style={styles.textItem}>No. KK</Text>
                      <Text style={styles.inputText}>{this.state.data.kk}</Text>
                      <TouchableOpacity
                        // onPress = {() => {}}
                    ...
                    <View style={styles.itemWrap}>
                      <Text style={styles.textItem}>Alamat Sekarang</Text>
                      <Text style={styles.inputText2}>
                        Desa {this.state.dataDesa.text}, Kecamatan{" "}
                        {this.state.dataKecamatan.text}, Kabupaten{" "}
                        {this.state.dataKabupaten.text},{" "}
                        {this.state.dataProvinsi.text}{" "}
                        {this.state.dataKodePos.text}
                      </Text>
                      <TouchableOpacity
                        // onPress = {() => {}}
                        ...
                        <View style={styles.tambahContainer}>
                          <View style={styles.tambahSubContainer3}>
                            ...
                            <View style={[styles.itemWrap, { padding: 10 }]}>
                              ...
                              <SelectDropdown
                                data={this.state.dataAllProvinsi.map(
                                  (d) => d.name,
                                )}
                            ...
                            <View style={[styles.itemWrap, { padding: 10 }]}>
                              ...
                              <SelectDropdown
                                data={this.state.dataAllKabupaten.map(
                                  (k) => k.name,
                                )}
                            ...
                            <View style={[styles.itemWrap, { padding: 10 }]}>
                              ...
                              <SelectDropdown
                                data={this.state.dataAllKecamatan.map(
                                  (p) => p.name,
                                )}
                    ...
                    <View style={styles.itemWrap}>
                      <Text style={styles.textItem}>Foto Kartu Keluarga</Text>
                      {this.renderFotoKK()}
                      <Modal
                        transparent={true}
