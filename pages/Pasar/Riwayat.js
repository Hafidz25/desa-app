...
const dataNotif = [
  {
    id: 1,
    type: "Promo",
    isi: "Telah di buka pemesanan Apartemen baru CLUSTER-FLAMBOYAN di Jogjakarta, dengan harga terjangkau",
    tgl: "05 April 2021",
    time: "07.15",
  },
  {
    id: 2,
    type: "Info",
    isi: "Tagihan Anda bulan April 2020 sudah bisa di bayar bisa bayar di mana saja",
    tgl: "01 April 2021",
    time: "16.30",
  },
];
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={{ marginTop: 10, marginBottom: 10, padding: 10 }}>
          <Text style={styles.tittleText}>Riwayat Transaksi</Text>
        </View>
        <FlatList
