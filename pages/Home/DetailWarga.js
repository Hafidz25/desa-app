...
export default class DetailWarga extends Component {
    ...
    _GetDataWarga = async () => {
        ...
        let url = "https://host02.birosolusi.com/edesa/public/api/v1/penduduks/" + id;
            ...
            return (
                <View style={styles.userDetail}>
                    ...
                    <View style={{ flexDirection: 'column' }}>
                        {this.state.dataName2.map((x, k) => <Text key={k} style={styles.isi}>{x}</Text>)}
                    </View>
                </View>
            )
        }
                        ...
                        <View style={styles.userInfoSection}>
                            <View style={{ alignItems: 'center', alignSelf: 'center' }}>
                                ...
                                <View>
                                    <Text style={[styles.title, {
                                        ...
                                        textAlign: 'center',
                                        marginBottom: 5,
                                    }]}>{this.state.dataName.value}</Text>
                                    <Text style={[styles.caption, {
                                        textAlign: 'center',
                                        marginBottom: 15,
                                    }]}>{this.state.data.nik}</Text>
                                </View>
                            </View>
                            <View style={styles.userDetail}>
                            ...
                            <View style={styles.search}>
                                <TouchableOpacity style={styles.loginBtn}
                                    onPress={() => this.props.navigation.navigate("Edit Data Warga")}>
                        ...
                        <View style={styles.userInfoSection3}>
                            <View style={styles.itemWrap}>
                                ...
                                <View style={{
                                    ...
                                    <TouchableOpacity style={styles.fileBtn}
                                        onPress={() => { this.setState({ fileKtp: true }) }}>
                                        <Text style={styles.fileText}>Show File</Text>
                                    </TouchableOpacity>
                                    <Modal
                                        backdropOpacity={0.5}
                                        isVisible={this.state.fileKtp}
                                        onBackdropPress={() => { this.setState({ fileKtp: false }) }}
                                        ...
                                        <View style={styles.options}>
                                            ...
                                            <TouchableOpacity style={{
                                                ...
                                                onPress={() => { this.setState({ fileKtp: false }) }}>
                                                <Text style={{
                                                    color: '#fff',
                                                    fontSize: 15,
                                                }}>Tutup</Text>
                            ...
                            <View style={styles.itemWrap}>
                                ...
                                <View style={{
                                    ...
                                    <TouchableOpacity style={styles.fileBtn}
                                        onPress={() => { this.setState({ fileTtd: true }) }}>
                                        <Text style={styles.fileText}>Show File</Text>
                                    </TouchableOpacity>
                                    <Modal
                                        backdropOpacity={0.5}
                                        isVisible={this.state.fileTtd}
                                        onBackdropPress={() => { this.setState({ fileTtd: false }) }}
                                        style={styles.contentView}>
                                        <View style={styles.options}>
                                            <Image
                                            ...
                                            <TouchableOpacity style={{
                                                ...
                                                onPress={() => { this.setState({ fileTtd: false }) }}>
                                                <Text style={{
                                                    color: '#fff',
                                                    fontSize: 15,
                                                }}>Tutup</Text>
                            ...
                            <View style={styles.itemWrap}>
                                ...
                                <View style={{
                                    ...
                                    <TouchableOpacity style={styles.fileBtn}
                                        onPress={() => { this.setState({ fileAgama: true }) }}>
                                        <Text style={styles.fileText}>Show File</Text>
                                    </TouchableOpacity>
                                    <Modal
                                        backdropOpacity={0.5}
                                        isVisible={this.state.fileAgama}
                                        onBackdropPress={() => { this.setState({ fileAgama: false }) }}
                                        style={styles.contentView}>
                                        <View style={styles.options}>
                                            <Image
                                                source={{ uri: 'http://10.0.0.151:8000/' + this.state.religionFile }}
                                                style={{
                                                    width: 350,
                                                    height: 220,
                                                    borderWidth: 2,
                                            ...
                                            <TouchableOpacity style={{
                                                ...
                                                onPress={() => { this.setState({ fileAgama: false }) }}>
                                                <Text style={{
                                                    color: '#fff',
                                                    fontSize: 15,
                                                }}>Tutup</Text>
