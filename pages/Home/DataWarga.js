  ...
  renderItem = ({ item, index }, onClick) => {
    ...
    return (
      ...
      >
        <TouchableOpacity
          onPress={() =>
            this.props.navigation.navigate("Detail Data Warga", {
              id: item.id,
              nik: item.nik,
              sex: item.sex,
            })
          ...
          <View style={styles.viewList}>
            <View style={styles.userBg}>
              <View style={styles.menuItem}>
                <Text style={styles.menuItemText}>{item.legal_name}</Text>
              </View>
              <View style={styles.menuItem}>
                <Text style={styles.bgText}>Usia : {item.age} Tahun</Text>
              </View>
              <View style={styles.jkStyle}>
                <Text style={styles.jkText}>{item.sex}</Text>
              </View>
            </View>
          </View>
        </TouchableOpacity>
