                ...
                <ScrollView>
                    <View style={{
                        ...
                        <TouchableOpacity style={styles.batalBtn}
                            ...
                            <View style={{
                                ...
                                <Icon style={{ right: 5 }} name='people' color={'#3C486B'} size={25} />
                        ...
                        <TouchableOpacity style={styles.batalBtn}
                            ...
                            <View style={{
                                ...
                                <Icon style={{ right: 5 }} name='person-add' color={'#3C486B'} size={25} />
                    ...
                    <View style={styles.menuContainer}>
                        ...
                        <TouchableOpacity
                            ...
                            style={[styles.menuWrapper, { width: '25%' }]}>
                            <View style={styles.menuBox}>
                                <Icon style={{ left: 3 }} name="ellipsis-horizontal-outline" size={40} color="#3C486B" />
                            </View>
